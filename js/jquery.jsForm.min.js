/*!
 * jQuery.jsForm v1.7.1 | (c) 2015 Niko Berger http://www.gargan.org/
...
!function(c, s, l) {
    ...
    t.prototype._init = function() {
            ...
            if (t && 0 === t.indexOf(a + ".")) {
                ...
                n && (c(this).children("." + n).removeClass(n), c(this).children().each(function() {
                    ...
                    if (a) for (let e = 0; e < i.length; e++) {
                        let t = i[e];
                        if (o && t && (t = t[o]), a == t || a == t.id) return n && c(this).addClass(n).trigger("selected"), 
        ...
        c.jsFormControls && c(t).jsFormControls(), t.on("delete", function(t, e) {
            ...
            if (!e || e[0] === this) {
                ...
                0 !== i.length && (a.detach(), i.before(a), s._reorder(a));
            }
        }), t.on("sortDown", function(t, e) {
            if (!e || e[0] === this) {
                let t = c(this), e = t.next(".POJO");
                0 !== e.length && (t.detach(), e.after(t), s._reorder(t));
            }
        ...
        const e = this;
        return c.each(this._getForm(), function() {
            if (0 < c("." + e.options.trackChanges, this).length) return !(t = !0);
        }), t;
    ...
    }, t.prototype.repaint = function(t, e) {
        t = t || this.element;
        try {
            this._fillDom(t, e);
        } catch (t) {
    ...
    "undefined" != typeof Handlebars && (Handlebars.registerHelper("currency", function(t) {
    ...
    }), Handlebars.registerHelper("iban", function(t) {
        return t ? l.jsFormControls.Format.iban(t) : "";
        ...
        t.find("input.mandatory,textarea.mandatory").on("input keyup", function() {
        ...
        t.find("input.date").each(function() {
            ...
            n.flatpickr ? n.flatpickr(s[0], {
                ...
                parseDate: t => {
                    let e = l.jsFormControls.Format.asMoment(t);
                    return e ? e.toJSDate() : new Date();
                },
            ...
            }) : s.datepicker && (e ? t = e : "undefined" != typeof i18n && (t = i18n.jqdate), 
            t ? l(this).datepicker({
                dateFormat: t
            }) : l(this).datepicker());
            ...
            l(this).on("change", function() {
                const t = l(this).val();
                4 !== t.length || isNaN(t) || l(this).val(t.substring(0, 2) + ":" + t.substring(2));
            }), l(this).clockpicker({
                placement: "bottom-adaptive",
                donetext: "Ok",
                forcedone: !0,
                autoclose: !0,
                afterDone: function(t, e, a) {
                    let i = l(this).find("input");
                    if (0 == i.length && (i = l(this)), l(document).data().touch || i.data().round) {
                        const n = i.val();
                        if (n && -1 != n.indexOf(":")) {
                            var s = n.split(":");
                            let t = Number(s[1]);
                            t % 5 < 3 ? t -= t % 5 : t += 5 - t % 5, 60 <= t && (t %= 60), i.val(s[0] + ":" + (t < 10 ? "0" : "") + t);
                        }
                    }
                }
        ...
        t.find("input.iban").on("change input keyup", function() {
            let t = l(this).val().trim();
            "" !== t || l(this).hasClass("mandatory") ? (l(this).hasClass("autoclean") && (t = t.toUpperCase(), 
            l(this).val(t.replace(/[^A-Z0-9]/g, "").replace(/(.{4})(?=.)/g, "$1 ").trim())), 
            (t => {
                t = t.replace(/\s+/g, "").toUpperCase();
                if (!/^[A-Z]{2}\d{2}[A-Z0-9]{1,30}$/.test(t)) return !1;
                let e = (t = t.slice(4) + t.slice(0, 4)).replace(/[A-Z]/g, t => t.charCodeAt(0) - 55);
                for (;2 < e.length; ) {
                    var a = e.slice(0, 9);
                    e = parseInt(a, 10) % 97 + e.slice(a.length);
                }
                return parseInt(e, 10) % 97 == 1;
            })(t) ? (l(this).val(l.jsFormControls.Format.iban(t)), l(this).addClass("valid").removeClass("invalid")) : l(this).removeClass("valid").addClass("invalid")) : l(this).addClass("valid").removeClass("invalid");
        });
        const e = /^[0-9.,-]+$/;
        t.find("input.number").on("input keyup", function() {
            let t = l(this).val();
            l(this).hasClass("currency") && t && (t = l.jsFormControls.Format._getNumber(t)), 
            0 != t.length ? l(this).hasClass("autoclean") ? l(this).val(t.replace(/[^0-9.,-]/g, "")) : e.test(t) ? l(this).addClass("valid").removeClass("invalid") : l(this).removeClass("valid").addClass("invalid") : l(this).hasClass("mandatory") ? l(this).removeClass("valid").addClass("invalid") : l(this).addClass("valid").removeClass("invalid");
        ...
        const a = /\D+$/;
        t.find("input.integer").on("input keyup", function() {
            const t = l(this).val();
            ...
            l(this).on("input keyup", function() {
            ...
            e.insertBefore(t), e.css("height", t.css("height"));
            const a = [];
            t.data().fullEdit ? (a.push([ "heading", "bold", "italic", "quote" ]), a.push([ "ul", "ol", "task", "indent", "outdent" ]), 
            a.push([ "table" ])) : (a.push([ "bold", "italic", "quote" ]), a.push([ "ul", "ol" ])), 
            t.data().image && a.push([ "image" ]), t.data().href && a.push([ "link" ]);
            var i = {
                el: e.get(0),
                toolbarItems: a,
                height: t.height() + "px",
            ...
            t.data().editor = new toastui.Editor(i), l(this).hide(), t.on("fill", function() {
        ...
        let a;
        if ("function" == typeof e) a = h[t], a && l.each(a, function() {
            e(this, l(this.element));
        }), r[t] = e; else if (a = h[t], a) {
        ...
        format: function(t, e) {
            let a = l(t);
            return a.hasClass("dateTime") || a.hasClass("datetime") ? isNaN(e) ? e : l.jsFormControls.Format.dateTime(e) : a.hasClass("date") ? isNaN(e) ? e : l.jsFormControls.Format.date(e) : a.hasClass("time") ? isNaN(e) ? e : a.hasClass("number") ? l.jsFormControls.Format.timeNum(e) : l.jsFormControls.Format.time(e) : a.hasClass("currency") ? l.jsFormControls.Format.currency(e) : a.hasClass("iban") ? l.jsFormControls.Format.iban(e) : a.hasClass("select") ? e ? a.data().options && a.data().options[e] ? a.data().options[e] : e : "" : a.hasClass("bool") ? e ? a.data().true || (i18n ? i18n.label.yes : "X") : a.data().false || "" : a.hasClass("byte") ? isNaN(e) ? e : l.jsFormControls.Format.byte(e) : a.hasClass("decimal") ? (a.data().processor = l.jsFormControls.Format.getDecimal, 
        ...
        _getValue: function(t, e, a, i, s) {
            return e === o && a === o || isNaN(t) || e === o || a === o ? t : a;
        },
        ...
        asMoment: function(a) {
            if (!a) return a;
            8 != a.length || isNaN(a) ? 12 != a.length || isNaN(a) || (a = a.substring(0, 2) + "." + a.substring(2, 4) + "." + a.substring(4, 8) + " " + a.substring(8, 10) + ":" + a.substring(10)) : a = a.substring(0, 2) + "." + a.substring(2, 4) + "." + a.substring(4);
            let i = null;
            const e = [ i18n.date.format + " " + i18n.date.timeFormat, i18n.date.dateTimeFormat, i18n.date.format, i18n.date.longDateFormat, i18n.date.timeFormat, "d.M.y H:m", "d.M.y", "d.M.y, H:m", "d/M/y H:m", "d/M/y", "M/dd/yy HH:mm", "M/dd/yyyy HH:mm" ];
            ...
            i) : a.getTime ? luxon.DateTime.fromJSDate(a) : luxon.DateTime.fromMillis(Number(a));
        ...
        integer: function(t) {
            ...
            const i = Number.parseInt(Math.abs(+t || 0), 10) + "";
        ...
        iban: function(t, e, a, i, s) {
            return (a = l.jsFormControls.Format._getValue(t, e, a, i)) ? (a = a.replace(/[^A-Za-z0-9]/g, "").toUpperCase()).replace(/(.{4})(?=.)/g, "$1 ").trim() : e ? "&#160;" : "";
        },
        ...
        _getMillis(t) {
            if (!t || "" === t || !isNaN(t)) return t;
            if (10 !== t.length && 15 < t.length && "T" != t[10] && " " != t[10]) return t;
            let e = luxon.DateTime.fromISO(t);
            return e.invalid ? (e = luxon.DateTime.fromRFC2822(t), e.invalid ? t : e.toMillis()) : e.toMillis();
        },
        date: function(t, e, a, i, s) {
            if (!(a = l.jsFormControls.Format._getValue(t, e, a, i)) || "" === a) return e ? "&#160;" : "";
            if (a = l.jsFormControls.Format._getMillis(a), isNaN(a)) return a;
            let n = null;
        ...
        time: function(t, e, a, i, s) {
            ...
            if (a = l.jsFormControls.Format._getMillis(a), isNaN(a)) return a;
            let n = "HH:mm";
            if ("undefined" != typeof i18n ? i18n.timeFormat ? n = i18n.timeFormat : i18n.date?.timeFormat && (n = i18n.date.timeFormat) : l(document).data().i18n && l(document).data().i18n.timeFormat && (n = l(document).data().i18n.timeFormat), 
            "undefined" != typeof luxon) {
                if (!isNaN(a)) return luxon.DateTime.fromMillis(Number(a)).toFormat(n);
                if (a.getTime) return luxon.DateTime.fromJSDate(a).toFormat(n);
            }
            const o = new Date();
...
}(jQuery, window), String.prototype.trim || (String.prototype.trim = function() {
...
}), String.prototype.startsWithIgnoreCase || (String.prototype.startsWithIgnoreCase = function(t) {
