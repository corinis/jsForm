/*!
 * jQuery.jsForm v1.5.5 | (c) 2015 Niko Berger http://www.gargan.org/
...
!function(c, s, l) {
    ...
    t.prototype._init = function() {
        ...
        if (!c(t).data().collections) {
            ...
            c(t).data().collections = n, c(".collection", t).each(function() {
                ...
                t && c(this).on("click", function() {
                    c(this).closest(".POJO").find("input[name='" + t + "']").data().pojo = null, c(this).closest(".POJO").find("input[name='" + t + "']").val("").change();
                });
                ...
                if (t && 0 === t.indexOf(s + ".")) {
                    ...
                    c(this).on("insert", function(t, e) {
                        ...
                        if (e) {
                            ...
                            t && c.isFunction(t) && !(e = t(e)) || (c.each(c(this).data("collections"), function() {
    ...
    }, t.prototype._handleArrayInPojo = function(e, s, n, o) {
        if (s[n] || (s[n] = []), "checkbox" === e.attr("type") || "CHECKBOX" === e.attr("type")) {
            let a = e.is(":checked"), i = !0;
            c.each(s[n], function(t, e) {
                if (this == o) return i = !1, a || s[n].splice(e, 1), !1;
            }), i && a && s[n].push(o);
        } else {
            let t = e.attr("data-array");
            t = !t || isNaN(t) ? null : Number(t), null === t ? s[n].push(o) : s[n][t] = o;
        }
        ...
        if (-1 === i.indexOf(".")) n && n.hasClass("array") ? this._handleArrayInPojo(n, t, i, s) : t[i] = s; else {
            ...
            e[o[t]] = a);
            e = o[o.length - 1], n && n.hasClass("array") ? this._handleArrayInPojo(c(this), a, e, s) : a[e] = s;
        }
        ...
        return c(t).find("input,select,textarea,button,.jsobject").each(function() {
            ...
            if (t = t || c(this).attr("name"), t && !c(this).hasClass("transient") && !c(this).hasClass("grayed") && 0 === t.indexOf(n + ".")) {
                ...
                c(this).hasClass("jsobject")) e = c(this).data().pojo; else {
                    ...
                    c(this).attr("data-obj") && (e = JSON.parse(c(this).attr("data-obj")))) : e = c(this).is(":checked"); else if ("radio" === c(this).attr("type") || "RADIO" === c(this).attr("type")) {
                        ...
                        } else e = new Date(e).getTime(); else e = r._getNumber(e);
                        isNaN(e) && (e = 0);
        ...
        if (t && 0 !== t.length) {
            const e = this;
            e.options.trackChanges && !c(t).data().track && (c(t).data().track = !0, c(t).change(function() {
        ...
        s.find(".selectcollection").each(function() {
            ...
            if (t && 0 === t.indexOf(a + ".")) {
                let i = null, s = t;
                a && (s = s.substring(a.length + 1)), i = r._get(e, s), i && c.isArray(i) || (i = []), 
        ...
        })), c("input,textarea,button", e).each(function() {
            let e = c(this).attr("name");
            if (e && (l._enableTracking(this), !o || 0 <= e.indexOf(o + "."))) {
                let t = e;
                o && (t = t.substring(o.length + 1));
                ...
                c(this).prop("checked", s == c(this).val())); else if (s || 0 === s || !1 === s || (s = ""), 
                c.jsFormControls && (s = c.jsFormControls.Format.format(this, s)), c(this).hasClass("array")) {
        ...
        return c.each(this._getForm(), function() {
            e._createPojoFromInput(this, i, s), e.options.validateHidden ? this.find(".invalid").each(function() {
                return n = !0, c(this).focus(), !1;
            }) : this.find(".invalid").filter(":visible").each(function() {
                return n = !0, c(this).focus(), t || e._debug("Found invalid field: " + c(this).attr("name")), 
                !1;
        ...
        return t.find(".collection").each(function() {
            if (!(!n && r || c(this).hasClass("transient"))) {
                let i = c(this).attr("data-field");
                if (i && 0 === i.indexOf(e + ".")) {
                    i = i.substring((e + ".").length);
                    let a = o._getParent(s, i, !0);
                    -1 !== i.indexOf(".") && (i = i.substring(i.lastIndexOf(".") + 1)), a[i] = [], c(this).children().each(function() {
                        var t = {}, e = o._createPojoFromInput(c(this), i, t);
                        if (e || o._getCollection(c(this), i, t, n), !o._isEmpty(t) || e) {
                            if (0 < c(".invalid", this).length && (r = !0, !n)) return !1;
                            e ? a[i].push(e) : a[i].push(t);
        ...
        if (e) {
            ...
            if (a) {
                if (!e.closest("span." + i)[0]) {
                    ...
                    a = c('<span class="' + i + '">' + t + "</span>");
                    (e.parent().hasClass("ui-wrapper") ? e.parent() : e).hide().wrap(a);
                }
            } else {
        ...
        r = r || o.val("data-prefill"), r && (c.isFunction(r) ? r(o.data().pojo, c(a)) : r.substring ? o.data().pojo = JSON.parse(r) : c.isPlainObject(r) && (o.data().pojo = r)), 
        ...
        var e = n[t];
        if (c.isFunction(a)) e && c.each(e, function() {
    ...
    "undefined" != typeof Handlebars && (Handlebars.registerHelper("currency", function(t) {
        ...
        t.find("input.mandatory,textarea.mandatory").on("keyup", function() {
            ...
            let t = null;
            var e = l(this).attr("data-format"), a = l(this);
            r.flatpickr ? r.flatpickr(a[0], {
                enableTime: !1,
                allowInput: !0,
                time_24hr: !1,
                dateFormat: i18n.flatpickrDate,
                onOpen: [ function(t, e, a) {
                    a.jumpToDate(new Date()), a.setDate(new Date());
                } ]
            }) : a.datepicker && (void 0 !== e ? t = e : "undefined" != typeof i18n && (t = i18n.jqdate), 
            t ? l(this).datepicker({
                dateFormat: t
            }) : l(this).datepicker());
            ...
            const s = l(this);
            if (r.flatpickr) r.flatpickr(l(this)[0], {
                enableTime: !0,
                time_24hr: !0,
                allowInput: !0,
                ...
                e ? t = e : "undefined" != typeof i18n && (t = i18n.momentDate);
                var a = "DTID_" + l(this).attr("name").replace(".", "_");
                const i = l('<div class="input-group date" data-target-input="nearest"/>');
                i.attr("id", a), s.parent().append(i), s.addClass("datetimepicker-input").attr("data-target", "#" + a);
                const n = l('<div class="input-group-append" data-toggle="datetimepicker"><div class="input-group-text"><i class="fa fa-calendar"></i></div></div>');
                i.append(s), i.append(n), n.attr("data-target", "#" + a), t ? l(this).datetimepicker({
                    format: "DD.MM.YYYY  HH:mm"
                }) : l(this).datetimepicker();
            } else if (l(this).jqxDateTimeInput) {
                l(this).data().valclass = "jqxDateTimeInput";
                const o = {
                    showTimeButton: !0
                };
                l(this).attr("data-width") ? o.width = Number(l(this).attr("data-width")) : o.width = l(this).width(), 
                e ? o.formatString = e : ("undefined" != typeof i18n ? t = i18n.date : l(document).data().i18n?.date && (t = l(document).data().i18n.date), 
                o.formatString = t.shortDateFormat + " HH:mm"), l(this).jqxDateTimeInput(o);
            }
        ...
        t.find("input.integer").keyup(function() {
            ...
            e.insertBefore(t), e.css("height", t.css("height")), t.data().editor = new toastui.Editor({
                ...
                events: {
                    change: function() {
                        t.val(t.data().editor.getMarkdown()), t.change();
                    }
                }
            }), l(this).hide(), t.on("fill", function() {
                console.log("filling", t.val()), t.data().editor.setMarkdown(t.val());
            });
            ...
            if (t) {
                ...
                e && a.addClass(e), a.click(function() {
                    ...
                    l(t).attr("value", i.value), l(t).change();
        ...
        let a;
        if ("function" == typeof e) a = o[t], a && l.each(a, function() {
            e(this, l(this.element));
        }), n[t] = e; else if (a = o[t], a) {
        ...
        format: function(t, e) {
            let a = l(t);
            return a.hasClass("dateTime") || a.hasClass("datetime") ? isNaN(e) ? e : l.jsFormControls.Format.dateTime(e) : a.hasClass("date") ? isNaN(e) ? e : l.jsFormControls.Format.date(e) : a.hasClass("time") ? isNaN(e) ? e : l.jsFormControls.Format.time(e) : a.hasClass("currency") ? l.jsFormControls.Format.currency(e) : a.hasClass("bool") ? e ? a.data().true || (i18n ? i18n.label.yes : "X") : a.data().false || "" : a.hasClass("byte") ? isNaN(e) ? e : l.jsFormControls.Format.byte(e) : a.hasClass("decimal") ? (a.data().processor = l.jsFormControls.Format.getDecimal, 
            ...
            l.jsFormControls.Format.humanTime(e)) : a.hasClass("timespan") ? l.jsFormControls.Format.timespan(e) : a.hasClass("timeday") ? e && l.jsFormControls.Format.time(Number(24 * e * 36e5)) : a.hasClass("humantimeday") ? e && (a.data().processor = l.jsFormControls.Format.getHumanTime, 
        ...
        asMoment: function(a) {
            let i = null;
            const e = [ i18n.date.format + " " + i18n.date.timeFormat, i18n.date.dateTimeFormat, i18n.date.format, i18n.date.longDateFormat, i18n.date.timeFormat, "d.M.y H:m", "d.M.y", "d/M/y H:m", "d/M/y" ];
        ...
        date: function(t, e, a, i, s) {
            ...
            o < 1900 && (o += 1900);
            let r = null;
            return "undefined" != typeof i18n ? r = i18n.date : l(document).data().i18n?.date && (r = l(document).data().i18n.date), 
            l.format ? l.format.date(n, r.shortDateFormat) : this._pad(n.getDate()) + "." + this._pad(n.getMonth() + 1) + "." + this._pad(o);
        },
        time: function(t, e, a, i, s) {
            ...
            n.setTime(a);
            let o = "HH:mm";
            return "undefined" != typeof i18n ? i18n.timeFormat ? o = i18n.timeFormat : i18n.date?.timeFormat && (o = i18n.date.timeFormat) : l(document).data().i18n && void 0 !== l(document).data().i18n.timeFormat && (o = l(document).data().i18n.timeFormat), 
            l.format ? l.format.date(n, o) : this._pad(n.getHours()) + ":" + this._pad(n.getMinutes());
        },
