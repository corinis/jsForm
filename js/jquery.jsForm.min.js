/*!
 * jQuery.jsForm v1.5.2 | (c) 2015 Niko Berger http://www.gargan.org/
    ...
    i.prototype._init = function() {
            ...
            if ((t = t || c(this).attr("name")) && !c(this).hasClass("transient") && !c(this).hasClass("grayed") && 0 === t.indexOf(n + ".")) {
                ...
                c(this).hasClass("jsobject")) a = c(this).data().pojo; else {
                    ...
                    c(this).attr("data-obj") && (a = JSON.parse(c(this).attr("data-obj")))) : a = c(this).is(":checked"); else if ("radio" === c(this).attr("type") || "RADIO" === c(this).attr("type")) {
                        ...
                        (c(this).hasClass("bool") || c(this).hasClass("boolean")) && (a = "true" === c(this).val());
                    } else if (c(this).hasClass("bool")) a = "true" === c(this).val(); else if (c(this).hasClass("boolean")) switch (c(this).val()) {
                      case "true":
                        a = !0;
                        break;
        ...
        t.on("refresh", function() {
            ...
            if (t && (!r || 0 <= t.indexOf(r + "."))) {
                ...
                if ((a = l.options.dataHandler ? l.options.dataHandler.deserialize(a, c(this), t, n) : a)[e] || !isNaN(a[e])) return c(this).find("option").each(function() {
                    var t = c(this).data().pojo;
        ...
        if (s && (t.empty(), c.isArray(e))) {
            ...
            for (var r = 0; r < e.length; r++) {
                ...
                l.data().pojo = o, l.addClass("POJO"), i && !1 === i(l, o) || (this._fillLine(t, o, l, a, r), 
                t.append(l), t.trigger("postAddCollection", [ l, c(l).data().pojo ]));
            }
        }
    }, i.prototype._fillLine = function(t, e, a, i, s) {
        var n = this;
        n._addCollectionControls(a), t.trigger("addCollection", [ a, e ]), i && (c(a).on("refresh", function() {
